...
class MICRO315Config(IntegrationConfig):
    ...
    model = ChatOpenAI(base_url=config.get('rcp', {})['base_url'], model='Qwen/Qwen3-VL-30B-A3B-Instruct-bfloat16', openai_api_key=config.get('rcp', {})['api_key'], request_timeout=60)

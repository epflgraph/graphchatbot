...
- Issue all independent tool calls at once rather than one at a time. Call again only if a later call depends on an earlier result, or if what came back does not answer the request.

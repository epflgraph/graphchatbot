...
- `weaknesses`: concepts that are still not solid. Only real gaps visible in the session; leave empty rather than manufacture them. State them candidly, and phrase each as something to revisit, not a verdict on the student.
